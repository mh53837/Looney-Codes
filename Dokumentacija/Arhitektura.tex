\chapter{Arhitektura i dizajn sustava}
	...
	\end{figure}
		...
		\textit{Arhitektura sustava može se podijeliti na tri glavna podsustava, a to su \textbf{Web poslužitelj, Web aplikacija i baza podataka}.}
	\begin{itemize}
	...
	\textit{Za izradu naše web aplikacije odabrali smo \textbf{Spring Boot} (open-source Java framework) i \textbf{React} (open-source JavaScript library). Odabrana razvojna okruženja su InteliJ IDEA i Eclipse IDE za Spring Boot, odnosno Visual Studio Code i WebStorm za React. Za izradu baze podatka koristimo PostgreSQL.}
	\textit{Arhitektura, koja je podržana Spring Boot-om, temelji se na \textbf{MVC (Model-View-Controller)} konceptu koji strogo odvaja model, akcije i prezentaciju, olakšava razvoj i održavanje aplikacije te čini aplikaciju prilagodljivom i jednostavnom za proširenje.}	
	\begin{itemize}
