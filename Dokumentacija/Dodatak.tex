...
%		 \textit{U ovom dijelu potrebno je redovito osvježavati dnevnik sastajanja prema predlošku.}
		...
		\section*{Tablica aktivnosti}
			...
			\begin{longtblr}[
				...
				\text{izrada front-end stranice} 			&  &  & 20 & 30 &  & 15 &  \\  
				\text{izrada baze podataka} 		 	&  &  & 4 &  &  & 4 & \\
				\text{spajanje s bazom podataka} 		& 1 &  &  &  & 5 & 3 &  \\
		        \text{back-end - servisi i controlleri}	& 14 & 15 &  &  & 15 & 20 & 13\\
		        \text{deployment}          				&  &  &  &  &  5 & 6 &\\ 
			\end{longtblr}
